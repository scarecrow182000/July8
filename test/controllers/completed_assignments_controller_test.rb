...
class CompletedAssignmentsControllerTest < ActionController::TestCase
  ...
  test "should create completed_assignment" do
    assert_difference('CompletedAssignment.count') do
      post :create, completed_assignment: { assignment: @completed_assignment.assignment, github_url: @completed_assignment.github_url, on_time: @completed_assignment.on_time, user: @completed_assignment.user }
    end
  ...
  test "should update completed_assignment" do
    patch :update, id: @completed_assignment, completed_assignment: { assignment: @completed_assignment.assignment, github_url: @completed_assignment.github_url, on_time: @completed_assignment.on_time, user: @completed_assignment.user }
    assert_redirected_to completed_assignment_path(assigns(:completed_assignment))
  end
